...
export const CONFIG_SCHEMA = [
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'rampPerBreak',  label: 'Speed-up per break (%)', type: 'range', min: 0, max: 50, step: 1, default: 0 },
      { key: 'rampOverTime',  label: 'Speed-up / sec (%)',     type: 'range', min: 0, max: 50, step: 1, default: 0 },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'splitOnEscape', label: 'Split in 2 on escape', type: 'checkbox', default: false },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'nearMiss',     label: 'Near-miss slow-mo + zoom', type: 'checkbox', default: false },
